const SOCIAL_ICONS = {
    Telegram: `<path d="M22 2L11 13M22 2l-7 20-4-9-9-4 20-7z" stroke="#534AB7" stroke-width="1.5"/>`,
    Instagram: `<rect x="2" y="2" width="20" height="20" rx="5" stroke="#534AB7" stroke-width="1.5"/>
                <circle cx="12" cy="12" r="4" stroke="#534AB7" stroke-width="1.5"/>`,
    Facebook: `<path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z" stroke="#534AB7" stroke-width="1.5"/>`,
    YouTube: `<path d="M22.54 6.42a2.78 2.78 0 00-1.94-2C18.88 4 12 4 12 4s-6.88 0-8.6.46a2.78 2.78 0 00-1.94 2A29 29 0 001 11.75a29 29 0 00.46 5.33A2.78 2.78 0 003.4 19c1.72.46 8.6.46 8.6.46s6.88 0 8.6-.46a2.78 2.78 0 001.94-2 29 29 0 00.46-5.25 29 29 0 00-.46-5.33z" stroke="#534AB7" stroke-width="1.5"/>
               <path d="M9.75 15.02l5.75-3.27-5.75-3.27v6.54z" stroke="#534AB7" stroke-width="1.5"/>`,
};
                    ...
                    <div class="contact-item">
                        <div class="contact-item-icon purple">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                                <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z" stroke="#534AB7" stroke-width="1.5"/>
                                <circle cx="12" cy="10" r="3" stroke="#534AB7" stroke-width="1.5"/>
                            </svg>
                        </div>
                        <div>
